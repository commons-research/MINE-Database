...
# target_cpds = "./example_data/starting_cpds_ten.csv"
# target_cpds = "./example_data/starting_cpds_three.csv"
# target_cpds = "./data/top_10_smiles_2D.csv"
...
# Should targets be flagged for reaction / it will be outputed
react_targets = False
