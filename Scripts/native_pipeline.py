...
cpd_ids = [
    "C000000588c5adcceec7bc0033b2404db527f006f",  # just 1 rxn
    ...
    "C32128af794b3adefa47a88712cc1967af41098de",
]  # last one has 3 rxns
...
pipeline = [
    ...
    {"$project": {"_id": 1, "KEGG_id": {"$arrayElemAt": ["$reactant_doc.ID", 0]}}},
    {"$group": {"_id": "$_id", "KEGG_ids": {"$addToSet": "$KEGG_id"}}},
    {"$match": {"KEGG_ids": {"$elemMatch": {"$in": model_ids}}}},
    {
        "$project": {
            "_id": 1,
        }
