...
###############################################################################
# a#### Starting Compounds, Cofactors, and Rules
...
# masses.
# See "./mine_database/data/adducts/All adducts.txt" for options.
...
if __name__ == "__main__":
    ...
    if write_to_csv:
        pk.assign_ids()
        pk.write_compound_output_file(output_dir + "/data/compounds.tsv")
        pk.write_reaction_output_file(output_dir + "/data/reactions.tsv")
