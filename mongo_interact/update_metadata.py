...
starting_compounds_ids = compounds_col.find(
...
for index, row in tqdm(
    ...
    metadata = {
        ...
        "structure_stereocenters_unspecified": row[
            "structure_stereocenters_unspecified"
        ],
        "structure_taxonomy_npclassifier_01pathway": row[
            "structure_taxonomy_npclassifier_01pathway"
        ],
        "structure_taxonomy_npclassifier_02superclass": row[
            "structure_taxonomy_npclassifier_02superclass"
        ],
        "structure_taxonomy_npclassifier_03class": row[
            "structure_taxonomy_npclassifier_03class"
        ],
        "structure_taxonomy_classyfire_chemontid": row[
            "structure_taxonomy_classyfire_chemontid"
        ],
        "structure_taxonomy_classyfire_01kingdom": row[
            "structure_taxonomy_classyfire_01kingdom"
        ],
        "structure_taxonomy_classyfire_02superclass": row[
            "structure_taxonomy_classyfire_02superclass"
        ],
        "structure_taxonomy_classyfire_03class": row[
            "structure_taxonomy_classyfire_03class"
        ],
        "structure_taxonomy_classyfire_04directparent": row[
